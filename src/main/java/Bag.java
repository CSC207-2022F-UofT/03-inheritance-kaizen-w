...
public abstract class Bag {
    ...
    public boolean addItem(String item){
        if(this.numberOfContents < this.capacity){
            int index = this.numberOfContents;
    ...
    public String popItem(){
        if(this.numberOfContents == 0){
            ...
            int last_obj_index = this.numberOfContents - 1;
            String last_obj = this.contents[last_obj_index];
    ...
    public void increaseCapacity(int n) {
        this.capacity += n;
        String[] extra_bag_space = new String[this.capacity];

        for(int i = 0; i < this.numberOfContents; i++){
            extra_bag_space[i] = this.contents[i];
        }
        this.contents = extra_bag_space;
